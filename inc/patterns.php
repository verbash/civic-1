...
function civic_1_register_patterns(): void {
	$patterns = array(
		...
		array(
			...
			'title'       => __( 'cv1 H3 heading — inline', 'civic-1' ),
			'description' => __( 'H3 subsection heading for flowing page content (no anchor ID). Use below a cv1 H2 when you do not need hub anchor-tab navigation.', 'civic-1' ),
			'categories'  => array( 'civic-1', 'text' ),
		...
		array(
			...
			'title'       => __( 'cv1 H3 heading — anchored', 'civic-1' ),
			'description' => __( 'H3 with anchor ID for hub anchor-tab navigation. Use on hub pages (Resources, Programs) where on-page jump links are needed. For plain subsections without tabs, use "cv1 H3 heading — inline" instead.', 'civic-1' ),
			'categories'  => array( 'civic-1', 'text' ),
		...
		array(
			...
			'description' => __( 'Heading + description + button card. Use inside a Columns block for multi-card rows. Add an Image block above the title after inserting.', 'civic-1' ),
			'categories'  => array( 'civic-1' ),
		...
		array(
			...
			'title'       => __( 'cv1 blank page', 'civic-1' ),
			'description' => __( 'Starting point for any new page — site header, empty content area, site footer. Set the page to the "Blank" WordPress template before inserting to avoid a duplicate header/footer.', 'civic-1' ),
			'categories'  => array( 'cv1-layout' ),
			'keywords'    => array( 'page', 'template', 'layout', 'full width', 'blank', 'new page' ),
			'file'        => 'page-template.html',
		),
		array(
			'slug'        => 'civic-1/feature-page',
			'title'       => __( 'cv1 embed page', 'civic-1' ),
			'description' => __( 'Header + H2 title + description + shortcode placeholder. Use for pages that embed a third-party tool (wpForo, CalendarWiz, etc.). Set the page to the "Blank" WordPress template before inserting.', 'civic-1' ),
			'categories'  => array( 'cv1-layout' ),
